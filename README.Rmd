...
This repository recreates the stock assessment for plaice (*Pleuronectes platessa*) in Division 7.e (western English Channel) in `R` from WGCSE 2024 - **but with the new chr rule agreed by WKBPLAICE 2024**
...
So far, a different branch of the `cat3advice` package is needed, which includes the discard survival considerations:
